...
//   Future saveDelinquent(
//       id, uid, plateNo, dateToday, fullName, secNameC, imgEmp, imgGuard) async {
//     await db.olSaveDelinquent(
//         id, uid, plateNo, dateToday, fullName, secNameC, imgEmp, imgGuard);
//   }
...
//     var _empSignature = new Signature(
//       height: 150,
...
//               style: TextStyle(fontSize: width / 36, color: Colors.black),
//             ),
//           ),
//         ],
//         textTheme: TextTheme(
...
//             child: Text("Plate #: " + widget.plateNo,
...
//                     color: Colors.blue,
//                     onPressed: () async {
//                       if (_guardSignature.isNotEmpty &&
//                           _empSignature.isNotEmpty &&
//                           _secNameController.text.isNotEmpty) {
//                         var dateToday = DateFormat("yyyy-MM-dd H:mm:ss")
...
//                               content: new Text(
//                                   "Please check security field and the sign pad "),
//                               actions: <Widget>[
//                                 // usually buttons at the bottom of the dialog
//                                 new FlatButton(
//                                   child: new Text("Close"),
